...
const REGIONS = {
  ...
  sgACC: { x: 100, y: 135, sub: "aff",  full: "Subgenual Anterior Cingulate Cortex", desc: "Affective processing node. Dysregulated in depression; linked to negative mood and emotional withdrawal." },
};
...
const HierarchyTab = () => {
  ...
  const nodePos = {
    ...
    TPJ:   { cx: subCenters.dm.cx - 52,  cy: subCenters.dm.cy + 10 },
  ...
  const bobVals = {
    ...
    TempP: "0,0; -1.6,2.6; 0,0; 1.6,-2.6; 0,0",
                ...
                return (
                  <g key={regionNode.id}>
                    ...
                    <g style={{ cursor: "pointer", transformOrigin: `${np.cx}px ${np.cy}px`, transform: `scale(${scl})`, transition: "transform 0.25s ease" }}
                      ...
                      <text x={np.cx} y={np.cy + 1} textAnchor="middle" dominantBaseline="central"
                        fill={isH ? "#fff" : color}
                        fontSize={regionNode.id === "TempP" ? 8 : 9.5} fontWeight={700}
